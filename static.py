...
def rank(month):
    ...
    while 1:
        ...
        if month == 7:
            ...
            return [float(count_1_1 / count_all_month),
                    float(count_2_1 / count_all_month),
                    float(count_3_1 / count_all_month),
                    float(count_4_1 / count_all_month),
                    float(count_5_1 / count_all_month),
                    float(count_6_1 / count_all_month)]
        elif month == 8:
            count_all_month = count_1_2 + count_2_2 + count_3_2 + count_4_2 + count_5_2 + count_6_2
            return [float(count_1_2 / count_all_month),
                    float(count_2_2 / count_all_month),
                    float(count_3_2 / count_all_month),
                    float(count_4_2 / count_all_month),
                    float(count_5_2 / count_all_month),
                    float(count_6_2 / count_all_month)]
        elif month == 9:
            count_all_month = count_1_3 + count_2_3 + count_3_3 + count_4_3 + count_5_3 + count_6_3
            return [float(count_1_3 / count_all_month),
                    float(count_2_3 / count_all_month),
                    float(count_3_3 / count_all_month),
                    float(count_4_3 / count_all_month),
                    float(count_5_3 / count_all_month),
                    float(count_6_3 / count_all_month)]
        elif month == 10:
            count_all_month = count_1_4 + count_2_4 + count_3_4 + count_4_4 + count_5_4 + count_6_4
            return [float(count_1_4 / count_all_month),
                    float(count_2_4 / count_all_month),
                    float(count_3_4 / count_all_month),
                    float(count_4_4 / count_all_month),
                    float(count_5_4 / count_all_month),
                    float(count_6_4 / count_all_month)]
        elif month == 11:
            count_all_month = count_1_5 + count_2_5 + count_3_5 + count_4_5 + count_5_5 + count_6_5
            return [float(count_1_5 / count_all_month),
                    float(count_2_5 / count_all_month),
                    float(count_3_5 / count_all_month),
                    float(count_4_5 / count_all_month),
                    float(count_5_5 / count_all_month),
                    float(count_6_5 / count_all_month)]
        elif month == 12:
            count_all_month = count_1_6 + count_2_6 + count_3_6 + count_4_6 + count_5_6 + count_6_6
            return [float(count_1_6 / count_all_month),
                    float(count_2_6 / count_all_month),
                    float(count_3_6 / count_all_month),
                    float(count_4_6 / count_all_month),
                    float(count_5_6 / count_all_month),
                    float(count_6_6 / count_all_month)]
        else:
            ...
            return [float((count_1_1 + count_1_2 + count_1_3 + count_1_4 + count_1_5 + count_1_6) / count_half_year),
                    float((count_2_1 + count_2_2 + count_2_3 + count_2_4 + count_2_5 + count_2_6) / count_half_year),
                    float((count_3_1 + count_3_2 + count_3_3 + count_3_4 + count_3_5 + count_3_6) / count_half_year),
                    float((count_4_1 + count_4_2 + count_4_3 + count_4_4 + count_4_5 + count_4_6) / count_half_year),
                    float((count_5_1 + count_5_2 + count_5_3 + count_5_4 + count_5_5 + count_5_6) / count_half_year),
                    float((count_6_1 + count_6_2 + count_6_3 + count_6_4 + count_6_5 + count_6_6) / count_half_year)]
